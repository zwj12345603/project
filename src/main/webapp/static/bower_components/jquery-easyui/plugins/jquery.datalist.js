...
$.fn.datalist.defaults=$.extend({},$.fn.datagrid.defaults,{fitColumns:true,singleSelect:true,showHeader:false,checkbox:false,lines:false,valueField:"value",textField:"generalcharacter",groupField:"",view:_7,textFormatter:function(_2c, row){
return _2c;
