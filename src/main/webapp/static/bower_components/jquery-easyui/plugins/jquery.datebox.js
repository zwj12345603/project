...
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter)?io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter(_10):io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter).appendTo(td);
