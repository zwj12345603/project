...
if(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter){
$("<span class=\"l-btn-text\"></span>").html(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter).appendTo(_e);
}else{
...
var t=$(_1e);
return $.extend({},$.parser.parseOptions(_1e,["id","iconCls","iconAlign","group","size","generalcharacter",{plain:"boolean",toggle:"boolean",selected:"boolean",outline:"boolean"}]),{disabled:(t.attr("disabled")?true:undefined),text:($.trim(t.html())||undefined),iconCls:(t.attr("icon")||t.attr("iconCls"))});
};
