...
_68.text=io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter;
$(_67.target).children("div.menu-text").html(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter);
});
...
return $("<div>"+io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter+"</div>").text()==_6d;
});
}else{
return _46(jq[0],_6d);
}
