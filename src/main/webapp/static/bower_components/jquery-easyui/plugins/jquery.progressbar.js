...
var _10=io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter.replace(/{value}/,_e);
var _11=_f.value;
_f.value=_e;
...
return $.extend({},$.parser.parseOptions(_12,["width","height","generalcharacter",{value:"number"}]));
};
