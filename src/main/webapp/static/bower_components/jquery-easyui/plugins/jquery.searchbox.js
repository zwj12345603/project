...
_7();
var _8=_9();
$(_2).addClass("searchbox-f").textbox($.extend({},_4,{icons:_5,buttonText:(_8?io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter:"")}));
...
$(_2).textbox("button").menubutton({text:io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter,iconCls:(_10.iconCls||null),menu:_3.menu,menuAlign:_4.buttonAlign,plain:false});
_3.searchbox.find("input.textbox-value").attr("name",_10.name||io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter);
$(_2).searchbox("resize");
};
};
