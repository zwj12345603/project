...
var _1a=_19.data;
_18.accordion({width:_17.floatMenuWidth,multiple:false}).accordion("add",{title:io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter,collapsed:false,collapsible:false});
...
acc.accordion("add",{title:io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter,selected:_2f[i].state=="open",iconCls:_2f[i].iconCls,onBeforeExpand:function(){
