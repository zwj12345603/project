...
_e9.val(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter).focus();
_e9.width(_e8+20);
...
return io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter;
...
var _12c=io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter.toLowerCase().indexOf(qq[i].toLowerCase());
if(_12c>=0){
return true;
}
}
