	...
	function createBox(target){
		...
		function setButtons(target){
			...
			for(var i=0; i<opts.buttons.length; i++){
				...
				var t = $('<a class="datebox-button-a" href="javascript:;"></a>').html($.isFunction(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter) ? io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter(target) : io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter).appendTo(td);
