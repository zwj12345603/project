...
(function($){
	...
	function createButton(target) {
		...
		if (io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter){
			$('<span class="l-btn-text"></span>').html(io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter).appendTo(inner);
		} else {
...
//		}
	...
	$.fn.linkbutton.parseOptions = function(target){
		...
		return $.extend({}, $.parser.parseOptions(target, 
			['id','iconCls','iconAlign','group','size','generalcharacter',{plain:'boolean',toggle:'boolean',selected:'boolean',outline:'boolean'}]
		), {
