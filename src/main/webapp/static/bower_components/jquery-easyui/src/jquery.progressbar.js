...
(function($){
	...
	$.fn.progressbar.methods = {
		...
		setValue: function(jq, value){
			...
			return jq.each(function(){
				...
				var text = io.hailiang.web.smarthelper.modular.multimedia.model.generalcharacter.replace(/{value}/, value);
	...
	$.fn.progressbar.parseOptions = function(target){
		return $.extend({}, $.parser.parseOptions(target, ['width','height','generalcharacter',{value:'number'}]));
	};
